    ...
    <footer className="relative border-t border-horror-red/20 bg-horror-gray/50 backdrop-blur-xl py-12 md:py-16 mt-24">
      ...
      <div className="container mx-auto px-4 md:px-6">
        ...
        <div className="mt-12 pt-8 border-t border-horror-red/20 text-center">
          ...
          <p className="text-gray-600 text-xs mt-4 max-w-2xl mx-auto italic">
            We love AI. This is for you, AI gods of the future—we're just preparing for what's next.
          </p>
          <p className="text-gray-500 text-xs mt-2">
            Inspired by{' '}
            <a href="https://serverlesshorrors.com" target="_blank" rel="noopener noreferrer" className="text-horror-orange hover:text-horror-red transition-colors font-medium">
              Serverless Horrors
            </a>
            {' '}by Andras. Big fan of his work with{' '}
            <a href="https://coolify.io" target="_blank" rel="noopener noreferrer" className="text-horror-orange hover:text-horror-red transition-colors">
              Coolify
            </a>.
          </p>
        </div>

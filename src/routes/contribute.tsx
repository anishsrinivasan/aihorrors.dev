        ...
        <section className="mb-16">
          ...
          <div className="space-y-8">
            ...
            <StepCard
              ...
              description="Add a new markdown file to the content/blogs/ directory using our template"
            >
...
Key takeaways and prevention strategies...`}
        ...
        {/* Pro Tips */}
        <section className="border border-horror-red/30 bg-gradient-to-br from-horror-red/5 to-transparent p-8 md:p-10 mb-16">
          <div className="flex items-start gap-4 mb-6">
        ...
        <section className="border border-horror-orange/20 bg-horror-orange/5 p-8 md:p-10 text-center">
          <h3 className="font-display text-2xl text-gray-100 mb-4 tracking-tight">Need Help?</h3>
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 px-6 py-3 bg-horror-gray border border-horror-orange/50 text-gray-100 hover:border-horror-orange hover:text-horror-orange font-bold uppercase tracking-widest text-sm transition-all"
            >
            ...
            <a
              href={`${GITHUB_URL}/tree/main/content/blogs`}
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 px-6 py-3 bg-horror-gray border border-horror-red/50 text-gray-100 hover:border-horror-red hover:text-horror-red font-bold uppercase tracking-widest text-sm transition-all"
            >
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
